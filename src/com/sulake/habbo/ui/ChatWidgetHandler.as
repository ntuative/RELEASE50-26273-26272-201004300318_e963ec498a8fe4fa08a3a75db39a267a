package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_537:Point = null;
      
      private var var_748:Map = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_536.length)
            {
               _loc2_ = var_536.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_536.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_748.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_311:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_536.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_748.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_550,RoomWidgetChatSelectAvatarMessage.const_672];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_550:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_149,_container.roomSession,0,"Version 26273-26272-201004300240");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_672:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_926 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_926);
            }
            if(var_537 == null)
            {
               var_535.x = 0;
               var_535.y = 0;
               var_535.z = 0;
               var_537 = _loc4_.getScreenPoint(var_535);
               var_926 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_535.x = 0;
            var_535.y = 0;
            var_535.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_535);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_537.x || _loc8_.y != var_537.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_537,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_297;
      }
