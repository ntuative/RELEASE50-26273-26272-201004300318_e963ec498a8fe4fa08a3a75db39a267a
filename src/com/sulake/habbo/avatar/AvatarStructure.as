package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_387:PartSetsData;
      
      private var var_1685:PartOffsetData;
      
      private var var_789:AvatarActionManager;
      
      private var var_168:IAssetLibrary;
      
      private var var_962:IAssetLibrary;
      
      private var var_1686:AvatarRenderManager;
      ...
      private var var_1418:AvatarStructureDownloadSet;
      
      private var var_1141:Array;
      
      private var var_662:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_168 = param2;
         var_962 = param3;
         var_295 = new FigureData();
         var_387 = new PartSetsData();
         _animationData = new AnimationData();
         var_1418 = new AvatarStructureDownloadSet();
         var_662 = new AnimationManager();
         var_661 = param4;
         var_1685 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_789.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_789.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_295.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_789.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_662.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_387.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_387.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1289[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_789.getDefaultActionType();
         var _loc9_:Array = var_387.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_662.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_295.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_295.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_387.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_387.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_661 + " ready to go!");
         if(var_661 == AvatarType.const_86)
         {
            var_387.getPartDefinition("ri").appendToFigure = true;
            var_387.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_661)
         {
            case AvatarType.const_86:
               ...
               var_1418.add(new AvatarStructureDownload(var_168,_loc5_,var_295));
               break;
            case AvatarType.PET:
         }
         var_1418.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_662.getAnimation(param1);
      }
      ...
      {
         var_789 = new AvatarActionManager(var_168,var_661);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1141 = var_295.getMandatorySetTypeIds();
         return var_1141;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_295.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_962.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_962.getAssetByName("dance" + _loc1_).content as XML;
            var_662.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_962.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_962.getAssetByName("fx" + _loc1_).content as XML;
            var_662.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_295.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_295.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_789.sortActions(param1);
      }
   }
}
