package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_155[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_155[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_155)
         {
            _loc6_ = var_155[_loc3_];
      ...
      {
         var_155 = new Dictionary();
         var_155["rooms_icon"] = ["gohome_white","gohome_color"];
         var_155["dance_icon"] = ["dance_white","dance_color"];
         var_155["clothes_icon"] = ["clothes_white","clothes_color"];
         var_155["effects_icon"] = ["effects_white","effects_color"];
         var_155["badges_icon"] = ["badges_white","badges_color"];
         var_155["wave_icon"] = ["wave_white","wave_color"];
         var_155["hc_icon"] = ["_white","_color"];
         var_155["settings_icon"] = ["settings_white","settings_color"];
         var_155["credits_icon"] = ["credits_white","credits_color"];
         var_155["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_981);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_802));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_728);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_846));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_300);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1019));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_660);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "HabboHelpCom_back_hi_png";
               if(false && _loc4_)
               {
