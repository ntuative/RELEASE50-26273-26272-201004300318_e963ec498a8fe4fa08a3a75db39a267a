package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2407:Dictionary;
      ...
      private var var_940:RoomCreateViewCtrl;
      
      private var var_1850:RoomThumbnailRenderer;
      
      private var var_189:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_636:RoomInfoViewCtrl;
      ...
      private var var_972:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_290 = new MainViewCtrl(this);
         var_636 = new RoomInfoViewCtrl(this);
         var_940 = new RoomCreateViewCtrl(this);
         var_1850 = new RoomThumbnailRenderer(this);
         var_972 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_411 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_290.startSearch(Tabs.const_203,Tabs.const_329,param1);
         var_290.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_150.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_290.startSearch(Tabs.const_277,Tabs.const_215);
         var_411.getTab(Tabs.const_277).method_3.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_290.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
