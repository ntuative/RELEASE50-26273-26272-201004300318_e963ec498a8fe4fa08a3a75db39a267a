package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1378:Boolean = true;
      
      private var var_941:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_545 = new Timer(100);
         var_545.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         ...
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,80,"g"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,74,"h"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,416,"o"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,352,"p"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,304,"q"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,336,"r"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,748,"u"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,438,"v"));
      ...
      private function prepare() : void
      {
         ...
         var_1110 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_545)
         {
            var_545.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_545.reset();
            var_545 = null;
         }
      }
      ...
      {
         var_1110.goBackToInitialState();
         var_1110.input.textBackgroundColor = 4294967295;
         var_941 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_60,HabboWindowStyle.const_43,HabboWindowParam.const_72,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1110.getText();
      ...
      {
         var _loc1_:Boolean = var_1110.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_941.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1378 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1378 = true;
            _loc3_.y = 1;
