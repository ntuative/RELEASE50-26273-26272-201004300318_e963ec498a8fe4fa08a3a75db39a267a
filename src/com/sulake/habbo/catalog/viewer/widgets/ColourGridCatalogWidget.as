package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1326 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_312 = null;
         for each(_loc1_ in var_1325)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1326) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_740.width,var_740.height,true,0);
               _loc3_.bitmap.copyPixels(var_740,var_740.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_905.width,var_905.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_742.width,var_742.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_742,var_742.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_742 = _loc4_.content as BitmapData;
         populateColourGrid();
