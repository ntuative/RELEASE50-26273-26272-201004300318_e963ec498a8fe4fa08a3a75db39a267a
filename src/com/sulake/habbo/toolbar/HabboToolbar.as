package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_118,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_937,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_162,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_157,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_51,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_422,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_568,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_947,onHideWindowEvent);
         var_34 = true;
