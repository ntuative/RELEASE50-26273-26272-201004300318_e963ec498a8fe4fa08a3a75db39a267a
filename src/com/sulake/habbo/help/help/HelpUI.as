package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1444:int = 0;
      
      private static const const_1443:int = 0;
      ...
      private var var_2245:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26273-26272-201004300240");
         var_189 = param5;
         var_108 = new Map();
         var_108.add(HabboHelpViewEnum.const_1332,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_147,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_450,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_266,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_237,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_625,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_291,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_632,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_220,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_108.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_108.add(HabboHelpViewEnum.const_987,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_678,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_280 == HabboHelpViewEnum.const_147 || false)
         {
            return;
         }
         if(var_444 == null)
         {
            ...
            var_444 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_444 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_444 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_444 as IWindow);
      ...
      {
         return var_108.getValue(var_280);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_108.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_108.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_2243 = param1;
         var _loc2_:IHelpViewController = var_108.getValue(HabboHelpViewEnum.const_147) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_220:
               ...
               break;
            case CallForHelpResultEnum.const_923:
               showUI(HabboHelpViewEnum.const_987);
               break;
            case CallForHelpResultEnum.const_1000:
      ...
      {
         var _loc3_:* = null;
         if(var_280 == HabboHelpViewEnum.const_147)
         {
            return;
         }
         if(true)
         {
            ...
            var_626.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_626.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_444.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_626[1],var_626[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_626[0],var_626[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1603;
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_108.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_280);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_189 != null)
            {
               var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_373));
      }
