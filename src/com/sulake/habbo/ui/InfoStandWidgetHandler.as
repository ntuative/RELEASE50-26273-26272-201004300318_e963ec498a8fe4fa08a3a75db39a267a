   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_140,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_130,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_142,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_150,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_140,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_130,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_142,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_150,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_713);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_339);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_943);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_897);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_311)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_316)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_892)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_584);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_225)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_200)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_682);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1374;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_899;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1356);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_602.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_602.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_39);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_682);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_121];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_674);
         _loc1_.push(RoomWidgetUserActionMessage.const_703);
         _loc1_.push(RoomWidgetUserActionMessage.const_710);
         _loc1_.push(RoomWidgetUserActionMessage.const_410);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_520);
         _loc1_.push(RoomWidgetFurniActionMessage.const_256);
         _loc1_.push(RoomWidgetFurniActionMessage.const_652);
         _loc1_.push(RoomWidgetFurniActionMessage.const_530);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_693);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_744);
         _loc1_.push(RoomWidgetUserActionMessage.const_473);
         _loc1_.push(RoomWidgetUserActionMessage.const_658);
         _loc1_.push(RoomWidgetUserActionMessage.const_525);
         _loc1_.push(RoomWidgetUserActionMessage.const_1335);
         _loc1_.push(RoomWidgetPetCommandMessage.const_719);
         _loc1_.push(RoomWidgetPetCommandMessage.const_597);
         _loc1_.push(RoomWidgetUserActionMessage.const_685);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_121:
      ...
      public function dispose() : void
      {
         ...
         if(var_602 != null)
         {
            _loc1_ = var_602.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_602.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_473)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_687:
               ...
               break;
            case RoomWidgetUserActionMessage.const_685:
               _container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_674:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1021,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_710:
               ...
               break;
            case RoomWidgetUserActionMessage.const_410:
            ...
            case RoomWidgetUserActionMessage.const_729:
               ...
               break;
            case RoomWidgetUserActionMessage.const_520:
            ...
            case RoomWidgetFurniActionMessage.const_256:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_530:
            ...
            case RoomWidgetUserActionMessage.const_474:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_693:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_744:
               ...
               break;
            case RoomWidgetUserActionMessage.const_473:
