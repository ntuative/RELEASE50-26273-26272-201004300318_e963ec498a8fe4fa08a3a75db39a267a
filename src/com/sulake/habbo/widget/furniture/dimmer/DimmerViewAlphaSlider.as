package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_99 && param1.type != WindowMouseEvent.const_449)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1430 * (var_969 - var_671)) + var_671;
      }
   }
}
