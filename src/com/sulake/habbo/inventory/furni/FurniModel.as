package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_232,onObjectPlaced);
         var_473 = new Timer(const_1055,1);
         var_473.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_29.getSubCategoryViewId() == InventorySubCategory.const_259;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_531)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_232,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_473 != null)
            {
               var_473.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_473.stop();
               var_473 = null;
            }
            if(var_129 != null)
            {
               var_129.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_129.stop();
               var_129 = null;
            }
            if(var_675 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_675 == null)
         {
            var_675 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_675.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_259:
               ...
               break;
            case InventorySubCategory.const_837:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_129 = new Timer(param1,1);
            var_129.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_129.start();
         }
         else
         {
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_317);
         ...
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_299:
                  var_29.toggleInventoryPage(InventoryCategory.const_145);
            }
         }
      }
      ...
      {
         if(var_809 && param1.type == RoomEngineObjectEvent.const_232)
         {
            var_29.showView();
            var_809 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_301 || _loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
