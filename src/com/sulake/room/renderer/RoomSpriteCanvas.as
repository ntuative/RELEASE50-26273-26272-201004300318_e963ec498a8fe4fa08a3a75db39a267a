package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1947:Number = -10000000;
      
      private var var_1945:Number = -10000000;
      ...
      private var var_1030:IRoomRenderingCanvasMouseListener = null;
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_262 != null)
         {
            var_262.graphics.clear();
         }
         else
         {
            var_262 = new Sprite();
            var_262.name = "mask";
            _master.addChild(var_262);
         }
         var_262.graphics.beginFill(0);
         var_262.graphics.drawRect(0,0,param1,param2);
         var_700 = param1;
         var_701 = param2;
         var_52.graphics.clear();
         var_52.graphics.beginFill(var_2372);
      ...
      {
         var _loc11_:Number = param1 - var_700 / 2;
         var _loc12_:Number = param2 - var_701 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_700 != var_1948 || var_701 != var_1944)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_421.sortOn("z",0 | 0);
         if(_loc6_ < var_421.length)
         {
            var_421.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_421[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_850.push(_loc12_ - _loc2_);
         if(var_850.length == const_768)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_768)
            {
               _loc13_ += var_850[_loc14_];
               _loc14_++;
            }
            var_850 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_497.length)
            {
               cleanSprite(var_497[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_497 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_307 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_307.getKey(_loc1_);
            _loc3_ = var_307.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1030 != null)
                  {
                     var_1030.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1512,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_421.length)
         {
            return null;
         }
         return var_421[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1947 || param2 != var_1945)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_497.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         var _loc7_:RoomObjectCacheItem = var_496.getObjectCache(param2);
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_700 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_701))
                  {
