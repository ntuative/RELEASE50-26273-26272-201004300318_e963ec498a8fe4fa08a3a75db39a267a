package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private var var_278:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_375);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  _main.showView(TutorialUI.const_93);
                  break;
               case "button_usecurrent":
                  var_375 = _main.myName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_375);
         }
         if(var_278 == null)
         {
            var_278 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_278 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_278);
            var_278.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_278.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_916 = new NameSuggestionListRenderer(_main);
