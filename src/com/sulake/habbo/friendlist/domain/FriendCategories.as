package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategories
   {
      ...
      private var var_450:IFriendCategoriesDeps;
      
      private var var_906:Dictionary;
      
      public function FriendCategories(param1:IFriendCategoriesDeps)
      {
         var_88 = new Array();
         var_906 = new Dictionary();
         super();
         var_450 = param1;
      }
      ...
      private function updateCategories(param1:Array) : void
      {
         ...
         var _loc5_:* = null;
         flushReceivedStatus();
         findCategory(FriendCategory.const_395).received = true;
         findCategory(FriendCategory.const_905).received = true;
      ...
      public function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc2_.updatedFriends)
         {
            ...
            var_450.messenger.setFollowingAllowed(_loc4_.id,_loc4_.followingAllowed && _loc4_.online);
            _loc6_ = isFriendOnline(_loc4_.id);
            if(_loc6_ && !_loc4_.online)
            {
               var_450.messenger.setOnlineStatus(_loc4_.id,_loc4_.online);
               var_450.notifications.addOfflineNotification(_loc4_.name,_loc4_.realName);
            }
            if(!_loc6_ && _loc4_.online)
            {
               var_450.messenger.setOnlineStatus(_loc4_.id,_loc4_.online);
               var_450.view.setNewMessageArrived();
               var_450.notifications.addOnlineNotification(_loc4_.name,_loc4_.figure,_loc4_.realName);
            }
      ...
      {
         var _loc2_:int = !!param1.online ? int(param1.categoryId) : int(FriendCategory.const_395);
         var _loc3_:FriendCategory = findCategory(_loc2_);
         if(_loc3_ != null)
         {
            _loc3_.addFriend(param1);
            var_906[param1.id] = param1;
            return _loc3_;
         }
