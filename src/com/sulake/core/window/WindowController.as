package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1520:Point = new Point();
      ...
      protected var var_641:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_402 = _loc13_.blend;
            var_551 = _loc13_.treshold;
            if(var_645 != _loc13_.background)
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_113,WindowParam.const_141);
         var _loc2_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_143);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_333)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_279)
               {
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_994;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_645 = param1;
         var_552 = !!var_645 ? uint(var_552 | var_1399) : uint(var_552 & 16777215);
         var_165 = var_165 || param1;
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_77);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1969 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_966:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_332:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_933:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1273:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1354:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_335:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_575:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_880:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_740:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1016:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_842:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_466:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_697:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_967:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_560:
               _loc2_ = "null";
               break;
         ...
         if(_loc2_ == WindowEvent.const_185)
         {
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_80 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_482,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_509,var_8);
            var_17.visible = var_338;
         }
         return var_17;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_842,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var_402 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_835);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1036 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_340,this,param1));
         return param1;
      }
      ...
      {
         var_1399 = param1 & 4278190080;
         var_552 = !!var_645 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_77);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_985;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_167:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_383,this,null));
                     if(testParamFlag(WindowParam.const_170,WindowParam.const_141))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_179,WindowParam.const_143))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_387:
                  var_16.invalidate(this,var_8.union(var_56),WindowRedrawFlag.const_416);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_875,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_267,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_332:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_697,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_209,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_454:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_942);
                  break;
               case WindowNotifyEvent.const_482:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_466:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_416);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_209:
                  ...
                  break;
               case WindowNotifyEvent.const_383:
                  var_9.getRegionProperties(null,var_308);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_340:
      ...
      {
         return var_641 != null ? var_641 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1018;
         update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_332;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_560,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_740;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1036 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_424)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_463)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_401)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_361)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_1011,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_709,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_167,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1367,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_165 && var_551 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1520,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1520,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1239,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_67,false);
         _loc1_.type = WindowNotifyEvent.const_1308;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_308 = var_9.rectangle.clone();
               var_56.x = var_8.x;
               var_56.y = var_8.y;
               var_56.width = var_8.width;
               var_56.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_391,this,var_9));
            }
            else
            {
               var_308.x = 0;
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_466,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_641,properties,var_646.concat(),_id) as WindowController;
         _loc2_.var_551 = var_551;
         _loc2_.var_165 = var_165;
         _loc2_.var_1395 = var_1395;
         _loc2_.var_308 = var_308.clone();
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_449;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1016;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_34 == WindowState.const_414)
         {
            return true;
         }
