package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1600:int = 16777216;
      
      public static const const_1507:int = 1;
       
      
      private var var_2374:int = 69069;
      
      private var var_1302:int = 1;
      
      private var var_2373:int = 5;
      
      private var var_1567:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1567 * param2);
      }
      ...
      {
         var _loc1_:int = var_2374 * var_1302 + var_2373;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
