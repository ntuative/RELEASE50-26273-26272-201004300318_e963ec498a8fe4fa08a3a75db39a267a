package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1932:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1506:ILogger;
      ...
      private var var_413:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1020)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_168);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1230:
            case DisconnectReasonEvent.const_1382:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1149:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1344:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1931)
         {
      ...
      {
         var_1020 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_228);
         param1.send(new VersionCheckMessageComposer(401,var_1227,var_1930));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1428,"/");
      ...
      {
         var _loc4_:IConnection = var_57.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_413.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_413.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1932);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1428,"/");
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1227 = _habboConfiguration.getKey("flash.client.url","");
         var_1930 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_174 == null)
         {
         ...
         if(var_697 != null)
         {
            var_57.mode = HabboConnectionType.const_479;
            var_57.initConnection(HabboConnectionType.const_261);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1506 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_57 = param2 as IHabboCommunicationManager;
            _loc3_ = var_57.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_57.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_57.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_57.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_57.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_57.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_57.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_57.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_57.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_57.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_57.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_57.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_57.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
            var_57.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_57.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_617);
            _loc3_ = new InitCryptoMessageComposer(var_57.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1932 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_57.mode)
         {
            case HabboConnectionType.const_479:
               _loc6_ = "";
               ...
               var_1021 = _loc4_;
               var_174.loadBannerImage(_loc7_ + "?token=" + var_1021,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_908:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1345:
               var_581 = generateRandomHexString(30);
               var_413 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_413.init(var_581);
               _loc8_ = var_413.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1021);
         ...
         var _loc9_:IConnection = var_57.getHabboMainConnection(null);
         ...
         var_413 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_413.init(_loc14_);
            _loc15_ = var_413.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_57.mode = HabboConnectionType.const_908;
            }
         }
         var_57.initConnection(HabboConnectionType.const_261);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_197);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_107,onRoomSessionEnded);
      }
