package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1249:InfoStandPetData;
      
      private var var_126:Timer;
      
      private var var_797:InfoStandFurniView;
      
      private var var_391:InfostandFurniData;
      
      private var var_336:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1419:String = "infostand_bot_view";
      ...
      private var var_448:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_797 = new InfoStandFurniView(this,const_1418);
         var_191 = new InfoStandUserView(this,const_1416);
         var_298 = new InfoStandPetView(this,const_1417);
         var_336 = new InfoStandBotView(this,const_1419);
         var_448 = new InfostandUserData();
         var_391 = new InfostandFurniData();
         var_1249 = new InfoStandPetData();
         var_126 = new Timer(const_1637);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_191.setTags(param1.tags,var_1725);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_713,onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_140,onUserTags);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_595,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_474,var_298.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_713,onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_140,onUserTags);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_595,onBadgeImage);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_336.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_60,HabboWindowStyle.const_42,HabboWindowParam.const_42,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_250:
               ...
               {
                  _loc2_ = param1.id == var_448.userRoomId;
                  break;
               }
               if(var_298 != null && false && var_298.window.visible)
               {
                  _loc2_ = param1.id == var_1249.roomIndex;
                  break;
               }
