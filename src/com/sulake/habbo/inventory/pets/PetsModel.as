package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_29.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_29.method_1.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1180 && param1.type == RoomEngineObjectEvent.const_232)
         {
            var_29.showView();
            var_1180 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_29.roomSession.isRoomOwner)
         {
            var_1180 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_311,_loc3_.figure);
            var_29.closeView();
            return;
         }
         if(!var_29.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      public function method_2(param1:PetData) : void
      {
         if(var_981.add(param1.id,param1))
         {
            _view.method_2(param1);
         }
      }
      
      public function get roomSession() : IRoomSession
      {
         return var_29.roomSession;
      }
   }
}
