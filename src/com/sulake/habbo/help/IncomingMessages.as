package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(false)
         {
            var_23.tutorialUI.onChangeUserNameResult(param1);
         }
         if(false)
         {
            var_23.hotelMergeUI.onChangeUserNameResult(param1);
         }
      }
      ...
      private function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(false)
         {
            var_23.tutorialUI.onCheckUserNameResult(param1);
         }
         if(false)
         {
            var_23.hotelMergeUI.onCheckUserNameResult(param1);
         }
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FaqIndex = var_23.getFaq();
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            var_23.tellUI(HabboHelpViewEnum.const_237,_loc4_);
         }
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         var_23.ownUserName = _loc2_.newName;
         if(false)
         {
            var_23.tutorialUI.onUserNameChanged(_loc2_.newName);
         }
         if(false)
         {
            var_23.hotelMergeUI.onUserNameChanged(_loc2_.newName);
         }
      }
      ...
      private function onRoomEntryInfo(param1:IMessageEvent) : void
      {
         ...
         {
            var_23.enableCallForGuideBotUI();
         }
         else
         {
            var_23.disableCallForGuideBotUI();
         }
      }
      ...
      private function onCallForHelpResult(param1:IMessageEvent) : void
      {
         ...
         var_23.showCallForHelpResult(_loc4_);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_266,_loc6_);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         var_23.tutorialUI.onUserChanged();
      }
      ...
      private function onCallForHelpReply(param1:IMessageEvent) : void
      {
         ...
         var_23.showCallForHelpReply(_loc2_.message);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_23.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + getCloseReasonKey(_loc3_.closeReason) + "}",0,onAlertClose);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_147);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _userId = _loc2_.id;
         var_23.ownUserName = _loc2_.name;
      }
      
      private function onPendingCallsForHelpDeleted(param1:IMessageEvent) : void
      {
         var_23.showUI(HabboHelpViewEnum.const_291);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_23.updateTutorial(_loc2_.hasChangedLooks,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         var_23.userRegistry.registerRoom(var_23.localization.getKey(_loc3_));
      }
      ...
      private function onGuestRoomResult(param1:IMessageEvent) : void
      {
         ...
         var_23.userRegistry.registerRoom(_loc2_.data.roomName);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_450);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_625);
         var_23.tellUI(HabboHelpViewEnum.const_625,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_316)
            {
               var_23.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
         ...
         var_23.tellUI(HabboHelpViewEnum.const_678);
      }
