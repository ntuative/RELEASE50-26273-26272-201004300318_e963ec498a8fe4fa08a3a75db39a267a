package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_949:ITabSelectorWindow;
      
      private var var_845:Boolean = false;
      
      protected var var_1617:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1617 == null)
         {
            var_1617 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1617;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_949 == null)
         {
            var_949 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_949 != null)
            {
               var_949.procedure = selectorEventProc;
            }
         }
         return var_949;
      }
      ...
      {
         return !!var_845 ? selector.iterator : null;
      }
