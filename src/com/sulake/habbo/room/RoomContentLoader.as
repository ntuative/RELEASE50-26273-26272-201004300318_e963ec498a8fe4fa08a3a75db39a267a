package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_778:String = "selection_arrow";
      
      private static const const_777:String = "tile_cursor";
      
      private static const const_285:String = "RCL_PUBLICROOM_";
      
      private static const const_502:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_354:String = "place_holder";
      
      private static const const_1099:String = const_354;
      
      private static const const_1435:int = 0;
      
      private static const const_779:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_630:String = "RCL_LOADER_READY";
      ...
      private var var_430:Map = null;
      
      private var var_1066:IEventDispatcher = null;
      
      private var var_1298:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_513 = [];
         var_511 = [];
         var_2084 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2086 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_432 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_34:
                     if(var_513.indexOf(_loc4_) == -1)
                     {
                        var_513.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_32:
                     if(var_511.indexOf(_loc4_) == -1)
                     {
                        var_511.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_306,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_430 != null)
         {
            _loc2_ = var_430.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_512.add(_loc10_,_loc11_);
                              if(var_513.indexOf(_loc14_) < 0)
                              {
                                 var_513.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_511.indexOf(_loc14_) < 0)
                              {
                                 var_511.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_432 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_432.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_362 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_362.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_432.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_432.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_354,const_502,ROOM_CONTENT,const_777,const_778];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2084.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_178 && _loc5_ != RoomObjectLogicEnum.const_111)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_512.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_513.indexOf(param1) >= 0)
         {
            return const_354;
         }
         if(var_511.indexOf(param1) >= 0)
         {
            return const_502;
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_431 != null)
         {
            _loc2_ = var_431.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2086.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1298.add(_loc5_,_loc8_);
               var_179 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_306,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_2085)
         {
            ...
            if(var_1066 != null)
            {
               var_1066.dispatchEvent(new Event(const_630));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_48,furniDataLoadedHandler);
            var_1066 = param1;
            var_2089 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2088 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2087 = param2.getKey("public.room.dynamic.download.url","");
            var_2090 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_34 = const_779;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_362.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_431 != null)
         {
            var_431.remove(param1);
            var_431.add(param1,param2);
         }
         if(var_430 != null)
         {
            var_430.remove(param2);
            var_430.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_178 && _loc5_ != RoomObjectVisualizationEnum.const_111)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_429.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_362.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1298.getValue(param1) != null)
         {
            var_179 = var_1298.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_435,onContentLoaded);
            _loc6_ = 0;
