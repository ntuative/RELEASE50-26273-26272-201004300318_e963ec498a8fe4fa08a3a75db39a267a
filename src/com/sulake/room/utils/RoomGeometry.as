package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_536:Number = 64;
      
      public static const const_849:Number = 32;
      ...
      private var var_1497:Number = 1;
      
      private var var_2370:Number = 500;
      
      private var var_1496:Number = 1;
      
      private var var_83:Vector3d;
      
      private var var_84:Vector3d;
      
      private var var_2369:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_84 = new Vector3d();
         var_1013 = new Vector3d();
         var_1498 = 1;
         var_1496 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1497 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_406 != param1 * var_1497)
         {
            var_406 = param1 * var_1497;
            ++var_76;
         }
      }
      ...
      {
         if(var_407 != param1 * var_1498)
         {
            var_407 = param1 * var_1498;
            ++var_76;
         }
      }
      ...
      {
         if(var_405 != param1 * var_1496)
         {
            var_405 = param1 * var_1496;
            ++var_76;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1013.assign(_loc22_);
         }
         else
         {
            var_1013.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_405;
         _loc2_.z *= var_406;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1013);
         if(_loc3_ < var_2369 || _loc3_ > var_2370)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_405;
            _loc2_.z *= var_406;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1013);
         }
      ...
      {
         return new Vector3d(0 * var_407,0 * var_405,0 * var_406);
      }
      ...
      {
         return scale == const_536;
      }
      
      public function get scale() : Number
      {
         return var_207 / Math.sqrt(0.5);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_207;
         var _loc6_:Number = -param1.y / var_207;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_83,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_407,0 * var_405,0 * var_406);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_407,param2.y * var_405,param2.z * var_406);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_407,param3.y * var_405,param3.z * var_406);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_407,param4.y * var_405,param4.z * var_406);
