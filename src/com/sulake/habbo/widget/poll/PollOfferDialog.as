package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_527:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1399:String = "POLL_OFFER_STATE_OK";
      ...
      private var var_34:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_34 = const_1399;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_724,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_34 = const_527;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_385,_id));
