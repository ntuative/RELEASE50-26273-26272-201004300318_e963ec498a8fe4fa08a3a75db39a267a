package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_831:MarketPlaceOfferData;
      
      private const const_1423:int = 1;
      
      private const const_1642:int = 40;
      
      private var var_484:IWindowContainer;
      
      private const const_1422:int = 2;
      ...
      private const const_1643:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_484)
         {
            ...
            var_484 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_484)
         {
            return;
         ...
         updateStatusDisplay(const_1422,_loc2_.length);
         if(!var_400)
         {
            var_400 = new Timer(25);
            var_400.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_830 = 0;
         populateList();
         var_400.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_576)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_484 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_484.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1423);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_401.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_400)
         {
            var_400.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_400 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_830 >= var_576.length)
            {
               return true;
            }
            addListItem(var_576.getWithIndex(var_830));
            ++var_830;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_831.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_123)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_401));
            _loc7_.selection = 0;
         }
      }
