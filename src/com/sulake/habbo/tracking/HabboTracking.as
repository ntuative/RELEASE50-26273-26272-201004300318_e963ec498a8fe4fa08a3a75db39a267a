package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_754:uint = 11;
      ...
      private var var_158:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_966:int = -1;
      
      private var var_794:LagWarningLogger = null;
      
      private var var_793:IHabboWindowManager;
      ...
      private var var_169:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_220 = new PerformanceTracker();
         var_219 = new LatencyTracker();
         var_794 = new LagWarningLogger();
         var_1145 = new Array(const_754);
         var _loc4_:int = 0;
         while(_loc4_ < const_754)
         {
            var_1145[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1395,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1290,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_620,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_990,String(0));
         }
      ...
      {
         track("room_ad","click",[include(param1.clickUrl)]);
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1284);
               break;
            case HabboCommunicationEvent.const_617:
               trackLoginStep(HabboLoginTrackingStep.const_1337,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_228:
               trackLoginStep(HabboLoginTrackingStep.const_228);
               break;
            case HabboCommunicationEvent.const_168:
               trackLoginStep(HabboLoginTrackingStep.const_168);
               break;
            ...
            case HabboCommunicationEvent.const_197:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_197);
               if(var_219 != null)
               {
                  var_219.init();
               }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_288:
      ...
      {
         var_150 = IHabboConfigurationManager(param2);
         if(var_150)
         {
            Component(var_150).events.addEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
            if(var_219 != null)
            {
               var_219.configuration = var_150;
            }
            if(var_220 != null)
            {
               var_220.configuration = var_150;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_272.events.addEventListener(AdEvent.const_365,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1712)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1164);
            var_1712 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_990,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_620,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_617,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_228,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_158,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_168,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_197,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_578,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_371,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_382:
               var_794.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_793)
            {
               var_793.release(new IIDHabboWindowManager());
               var_793 = null;
            }
            if(var_272)
            {
            ...
            if(var_169)
            {
               if(true)
               {
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.const_288,onFriendlistTrackingEvent);
               }
               var_169.release(new IIDHabboFriendList());
               var_169 = null;
            }
            if(var_158)
            {
               if(true)
               {
                  var_158.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_158.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_158.release(new IIDHabboHelp());
               var_158 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_382,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_150)
         {
            if(var_794 != null)
            {
               var_794.configure(var_150);
            }
            Component(var_150).events.removeEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
         }
      }
      ...
      {
         var_158 = param2 as IHabboHelp;
         var_158.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_158.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_995);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_995,onCoreRunning);
         }
      }
      ...
      {
         var_793 = IHabboWindowManager(param2);
         if(var_793)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_966 > -1 && _loc2_ < var_966)
         {
            ++var_1422;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1422);
         }
         if(var_966 > -1 && _loc2_ - var_966 > 15000)
         {
            ++var_1421;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1421);
         }
         var_966 = _loc2_;
         if(var_220 != null)
         {
            var_220.update(param1);
         }
         if(var_219 != null)
         {
      ...
      {
         if(var_150 != null && Boolean(var_150.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_382,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_274,onRoomAdClick);
      }
      
      private function include(param1:String) : String
      {
      ...
      {
         var_169 = param2 as IHabboFriendList;
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.const_288,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_150)
            {
               if(var_150.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_150.getKey("client.fatal.error.url");
                  ...
                  if(var_220 != null)
                  {
                     _loc4_["null"] = var_220.flashVersion;
                     _loc4_["null"] = var_220.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_578)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1227);
         }
         else if(param1.type == HabboHotelViewEvent.const_371)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1228);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1333);
         }
      }
   }
}
