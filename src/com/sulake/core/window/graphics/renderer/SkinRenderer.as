package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_333)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_333[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_332[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinTemplate = var_332[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_333[param1] = _loc3_;
      }
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in var_332)
         {
            ISkinTemplate(var_332[_loc1_]).dispose();
            delete var_332[_loc1_];
         }
         var_332 = null;
         var_333 = null;
      }
