package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1463:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_507 = getKey("url_prefix");
         if(var_507 != null && false)
         {
            setKey("client.fatal.error.url",var_507 + "/flash_client_error");
         }
      ...
      {
         var _loc2_:String = var_1053[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_507 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_507.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1552.indexOf(param1) < 0)
         {
            var_1053[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_845 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_165));
         if(var_2043)
         {
      ...
      {
         var _loc4_:String = var_1053[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_507);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1463);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1463,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function init() : void
      {
         ...
         if(!var_845)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_48,onConfigurationError);
         }
      }
