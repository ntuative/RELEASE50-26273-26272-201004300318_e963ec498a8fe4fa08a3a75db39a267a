package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1415:int = 5;
      
      private static const const_504:int = 16;
      
      private static const const_1048:int = 20;
      
      private static const const_356:int = 10;
      
      private static const const_1047:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_968 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1722 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1724 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_668 = new Timer(1000,1);
         var_668.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_796 = new Timer(5000,1);
         var_796.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_60,HabboWindowStyle.const_42,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_47,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_123,onInputChanged);
         _window.addEventListener(WindowEvent.const_442,onWindowMoved);
         var_1148 = true;
         var_125 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1723 = _loc2_.width + const_504 + _loc6_.width + const_1048;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1047,_loc8_.width) + const_504);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_968 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_125 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_465);
