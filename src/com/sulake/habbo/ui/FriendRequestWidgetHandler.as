package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_337;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_691);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_529);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_609);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_691:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_39,_container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_529:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_609:
