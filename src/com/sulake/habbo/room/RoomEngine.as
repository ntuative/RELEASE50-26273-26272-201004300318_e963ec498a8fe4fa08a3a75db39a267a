package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_283:String = "object_icon_sprite";
      
      private static const const_770:int = -3;
      
      private static const const_771:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1091:String = "tile_cursor";
      ...
      private var var_587:NumberBank;
      ...
      private var var_310:Map = null;
      
      private var var_28:IRoomObjectFactory = null;
      
      private var var_66:RoomObjectEventHandler = null;
      
      private var var_707:RoomMessageHandler = null;
      
      private var var_706:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_310 = new Map();
         var_587 = new NumberBank(1000);
         var_1037 = new Map();
         var_309 = new Map();
         var_66 = new RoomObjectEventHandler(this);
         var_707 = new RoomMessageHandler(this);
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_310.length; _loc2_++)
         {
            _loc3_ = var_310.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_644) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_602) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_669) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_552) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_152);
            if(_loc7_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_429 != null)
         {
            var_429.release(new IIDRoomObjectVisualizationFactory());
            var_429 = null;
         }
         if(var_42 != null)
         {
         ...
         if(var_706 != null)
         {
            var_706.release(new IIDRoomRendererFactory());
            var_706 = null;
         }
         ...
         if(var_310 != null)
         {
            ...
            {
               _loc2_ = var_310.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_706.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_991;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_586);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_721);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_576);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_955);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_823) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1020);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_467,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_607,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_528,var_114,var_115,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_309.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_309.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_585,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_734,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_642,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_42 != null)
         {
            ...
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_39);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_70);
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_339,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_302,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_921,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_943,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_897,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_278,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_684,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_28 == null || var_429 == null || var_42 == null || var_706 == null || _communication == null || _habboConfiguration == null || !var_1976)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_284,RoomObjectCategoryEnum.const_70);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1176,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_42.getRoom(getRoomIdentifier(var_114,var_115));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_770,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_115,var_1248);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_283);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_115,var_1248);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_283);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_429;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_219,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_377,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_257,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_542,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_133,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_112,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_137,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_135,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_126,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_97,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_408,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_434,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_370,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_421,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_367,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_446,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_448,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_477,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_68,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_412,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_425,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_274,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_480,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_334,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_309,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_363,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_986,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_375,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_382,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_666) != 0)
         {
            return false;
         }
         if(var_66 != null)
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_499 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_649,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_309.length)
            {
               _loc3_ = var_309.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.targetCategory = RoomObjectCategoryEnum.const_39;
         }
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_278,param1,param2,param3,RoomObjectCategoryEnum.const_39));
         }
         return true;
      }
      ...
      {
         disposeObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_39);
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_427);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_630)
         {
            var_1976 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_339,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_302,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_991,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_278,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_272.events.addEventListener(AdEvent.const_365,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_771) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_310.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_706 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      
      private function getObjectUser(param1:int, param2:int, param3:int) : IRoomObjectController
      {
         return getObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_39);
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc11_:int = var_587.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_427,param8);
               break;
            case RoomObjectCategoryEnum.const_39:
            ...
            case RoomObjectCategoryEnum.const_70:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_247,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_712,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_746,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_467,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1037.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_825,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_587.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_769,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_283);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1522 - _loc12_.width / 2;
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_452,var_114,var_115,-1,RoomObjectCategoryEnum.const_229));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_66 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_284,const_498);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         else if(var_12 != null)
         {
            ...
            if(param2 == RoomObjectCategoryEnum.const_39)
            {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_115,var_1248);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_283);
            _loc11_ = addOverlayIconSprite(_loc10_,const_283,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1522 - _loc6_.data.width / 2;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_286,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_886,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_901,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_815,RoomObjectVariableEnum.const_286,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_310.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_310.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_630,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_825);
               ...
               var_587.freeNumber(_loc10_ - 1);
               _loc13_ = var_1037.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_114,var_115,const_284,RoomObjectCategoryEnum.const_70,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_997,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_666,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_873,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_284,const_498,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_666,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_586,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_644,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_669,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_602,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_552,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_585,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_734,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_642,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_467,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_208);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_721,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_576,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_721,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_576,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_955,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_769,const_1091,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_770,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
