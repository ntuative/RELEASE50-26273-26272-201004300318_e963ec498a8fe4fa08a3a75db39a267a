package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_426:UserInfoCtrl;
      
      private var var_58:ModerationManager;
      
      private var var_1052:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.releaseBundle(var_117.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_47,onResized);
         }
         ...
         var _loc3_:IssueMessageData = var_117.getHighestPriorityIssue();
         var_426 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_1052 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_426.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_117.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1052.load(_loc4_,var_117.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.closeBundle(var_117.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_117.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_117.getHighestPriorityIssue().issueId;
         var_58.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_58,WindowTracker.const_1010,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_58 != null && false && var_117 != null)
         {
            var_58.issueManager.removeHandler(var_117.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_117.getHighestPriorityIssue();
            var_426 = new UserInfoCtrl(_window,var_58,_loc3_.message);
            var_426.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.closeBundle(var_117.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_58.issueManager.closeBundle(var_117.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1316;
      }
   }
}
