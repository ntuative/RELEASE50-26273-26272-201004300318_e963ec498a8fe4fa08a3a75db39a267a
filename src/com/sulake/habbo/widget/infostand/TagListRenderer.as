package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1645:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1338 != null && var_1338.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_833 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_833 += param1.height + const_1645;
            return fit(param1);
         }
         param1.offset(_offsetX,var_833);
         _offsetX += param1.width + const_1644;
         return true;
      }
