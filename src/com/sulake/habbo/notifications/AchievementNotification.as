package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1667 = param2;
         var_339 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_130,onBadgeImageReady);
         ...
         var_211 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1668 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_211);
      ...
      public function dispose() : void
      {
         if(var_339 != null)
         {
            var_339.events.removeEventListener(BadgeImageReadyEvent.const_130,onBadgeImageReady);
            var_339 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_658,var_1668);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_658,var_658));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_658,var_658));
         _localizations.registerParameter(param1,"level",var_1667.toString());
         _localizations.registerParameter(param1,"name",var_339.userName);
         _localizations.registerParameter(param1,"realname",var_339.realName);
      }
   }
}
