package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1178:int = 7;
      ...
      public static const const_1163:int = 2;
      ...
      {
         var_1539 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1539[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1539[param1] = _loc2_;
         }
         return _loc2_;
      }
