package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_590:Function;
      
      private var _window:IWindowContainer;
      
      private var var_713:IAssetLibrary;
      
      private var var_868:uint = 0;
      
      private var var_591:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_713.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_37)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_371));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_713.loadAssetFromFile("hotel_view_banner_" + var_868,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_578));
            }
            var_591 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_713.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
