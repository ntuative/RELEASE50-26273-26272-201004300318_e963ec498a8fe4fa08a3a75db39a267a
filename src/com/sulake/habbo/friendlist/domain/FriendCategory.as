package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_905:int = 0;
      ...
      {
         return Math.ceil(this.var_222.length / const_341);
      }
      ...
      {
         if(this.var_829 >= this.getPageCount())
         {
            this.var_829 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_829 + 1) * const_341,this.var_222.length);
      }
