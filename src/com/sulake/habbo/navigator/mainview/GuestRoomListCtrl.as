package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_382:IScrollbarWindow;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1126 != null)
         {
            _loc2_ = var_1126.tags[0];
            var_1126.color = getBgColor(_loc2_);
         }
         var_1126 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_382 = IScrollbarWindow(var_20.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_1631 - _loc2_.stageX);
         var_1631 = _loc2_.stageX;
         var_1630 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_171,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_127,null,0);
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1347,true);
