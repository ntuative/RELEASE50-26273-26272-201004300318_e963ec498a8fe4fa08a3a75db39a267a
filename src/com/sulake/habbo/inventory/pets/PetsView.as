package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_312:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_489 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_595 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_595.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_312 != null)
         {
            var_312.setSelected(false);
         }
         var_312 = param1;
         if(var_312 != null)
         {
            var_312.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_312.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_595.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_489.removeGridItem(_loc2_.window);
         if(var_312 == _loc2_)
         {
            var_312 = null;
            selectFirst();
      ...
      public function method_2(param1:PetData) : void
      {
         ...
         if(var_595.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_489.addGridItem(_loc2_.window);
            var_595.add(param1.id,_loc2_);
            if(var_312 == null)
            {
               selectFirst();
            }
