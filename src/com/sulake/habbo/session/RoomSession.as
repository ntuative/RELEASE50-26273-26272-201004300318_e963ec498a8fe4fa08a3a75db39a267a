package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_34:String = "RSE_CREATED";
      
      private var var_986:UserDataManager;
      ...
      {
         if(var_34 == RoomSessionEvent.const_296 && _connection != null)
         {
            var_34 = RoomSessionEvent.const_95;
            if(isPrivateRoom)
            {
      ...
      {
         return var_986 as IUserDataManager;
      }
