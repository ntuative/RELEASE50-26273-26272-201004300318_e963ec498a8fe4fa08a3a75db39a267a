package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         var_144 = new ByteArray();
         var_55 = 0;
         while(var_55 < psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = var_55++;
            var_144[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            var_144[_loc4_ = var_55++] = _loc2_ & 255;
         }
         var_55 = 0;
         seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = var_55++;
         var_144[_loc2_] = 0 ^ param1 & 255;
         var _loc3_:* = var_55++;
         var_144[_loc3_] = 0 ^ param1 >> 8 & 255;
         var _loc4_:*;
         var_144[_loc4_ = var_55++] = 0 ^ param1 >> 16 & 255;
         var _loc5_:*;
         var_144[_loc5_ = var_55++] = 0 ^ param1 >> 24 & 255;
         var_55 %= psize;
         var_2277 = true;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_144[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         var_144.length = 0;
         var_144 = null;
