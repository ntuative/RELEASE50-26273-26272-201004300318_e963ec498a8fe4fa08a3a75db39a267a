   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_937,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_718,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_718,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_184,onCreditBalance);
         }
         var_11 = _container.inventory;
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1014,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_999,onHabboClubSubscriptionChanged);
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_681);
         _loc1_.push(RoomWidgetDanceMessage.const_556);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_534);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_717);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_533);
         _loc1_.push(RoomWidgetStopEffectMessage.const_580);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1187);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_907);
         _loc1_.push(RoomWidgetToolbarMessage.const_701);
         _loc1_.push(RoomWidgetToolbarMessage.const_707);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_635);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1154);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_938);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_636);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_559);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_600);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1169);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_628);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_547);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_725);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_541));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_559:
               ...
               break;
            case RoomWidgetWaveMessage.const_681:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_556:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_534:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_717:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_654:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_533:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1019)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_690:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_856:
                        _catalog.openCatalogPage(CatalogPageName.const_1346,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_846:
                        var_11.toggleInventoryPage(InventoryCategory.const_245);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1372:
            ...
            case RoomWidgetStopEffectMessage.const_580:
            ...
            case RoomWidgetNavigateToRoomMessage.const_907:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_636:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_701:
               ...
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_707:
               ...
               if(var_189 && false)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_422,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_635:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_453));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_600:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_294,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_628:
            ...
            case RoomWidgetStoreSettingsMessage.const_547:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_294,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_725:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_459));
               }
               break;
            default:
