package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1589:String = "hot_looks";
      
      public static const const_1612:String = "my_looks";
      ...
      {
         var _loc1_:String = var_29.configuration.getKey("avatareditor.promohabbos");
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:AssetLoaderStruct = var_29.assets.loadAssetFromFile("hotLooksConfiguration",_loc2_,"text/xml");
      ...
      public function selectHotLook(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            var_29.loadAvatarInEditor(_loc3_.figure,_loc3_.gender,var_29.clubMemberLevel);
         }
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         var _loc3_:XmlAsset = var_29.assets.getAssetByName("hotLooksConfiguration") as XmlAsset;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.content as XML;
            for each(_loc5_ in _loc4_.habbo)
            {
               _loc6_ = new Outfit(var_29,_loc5_.@figure,_loc5_.@gender);
