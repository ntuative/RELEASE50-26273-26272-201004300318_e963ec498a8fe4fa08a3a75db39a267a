package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1439:Rectangle;
      
      private var var_302:Dictionary;
      ...
      private var var_301:Rectangle;
      
      private var var_1438:Point;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_561 = new Array();
         var_1438 = new Point();
         var_1439 = new Rectangle();
         var_301 = new Rectangle();
         var_302 = new Dictionary(true);
         var_755 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_302[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_301.x = _loc3_.dirty.x;
               var_301.y = _loc3_.dirty.y;
               var_301.width = _loc3_.dirty.width;
               var_301.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_301);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_689,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_302[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_302[param1];
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1438,var_1439))
            {
               if(param2.render(param1,var_1438,var_1439))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_302[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_689,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_301.x = param2.x - param1.x;
            var_301.y = param2.y - param1.y;
            var_301.width = param2.width;
            var_301.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_35))
            {
               while(param1.testParamFlag(WindowParam.const_35))
               {
                  ...
                  var_301.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_301,WindowRedrawFlag.const_264);
