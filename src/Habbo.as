package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_10:String = "client.init.volter.retry";
      
      public static const const_3:String = "fileLoadingBar";
      
      public static const const_21:String = "error_desc";
      
      public static const const_4:String = "byteLoadingBar";
      ...
      public static const const_13:String = "crash_time";
      ...
      public static const const_22:String = "client.init.start";
      ...
      public static const const_12:String = "client.init.volter.loaded";
      
      private static const const_26:String = "testLocalConnection";
      
      public static const const_11:String = "error_data";
      
      public static const const_23:String = "flash_version";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_13] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_16] = _loc7_;
            _loc6_[const_23] = Capabilities.version;
            _loc6_[const_20] = 0;
            _loc6_[const_21] = param1;
      ...
      private static function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc6_:Sprite = param1.getChildByName(const_4) as Sprite;
         if(_loc6_)
         {
            _loc6_.x = 89;
            _loc6_.y = 179;
      ...
      private function onVolterLoadingFailedAgain(param1:IOErrorEvent) : void
      {
         ...
         Habbo.reportCrash("Failed to download Volter.swf!",const_17,new Error(param1.text));
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc9_:Sprite = param1.getChildByName(const_4) as Sprite;
      ...
      {
         trackLoginStep(const_8);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_4,const_7,null);
      }
