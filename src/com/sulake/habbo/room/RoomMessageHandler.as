package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1076:int = -1000000000;
      
      private var var_1312:Boolean = true;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_912,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_586);
         var _loc8_:int = 0;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_78.initializeTileMap(_loc7_,_loc8_);
         var _loc9_:* = -1;
         var _loc10_:* = -1;
         var _loc11_:* = 0;
         var _loc12_:* = 0;
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc20_ < _loc7_)
            {
               ...
               var_78.setTileHeight(_loc20_,_loc15_,_loc21_);
               _loc20_++;
            }
            _loc15_++;
         }
         if(!_loc13_)
         {
            var_78.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_);
         }
         ...
         var_78.initializeFromTileData(_loc16_);
         if(!_loc13_)
         {
            var_78.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_ + var_78.wallHeight);
         }
         _loc6_.scale = _loc3_.scale;
         _loc6_.initialize(_loc7_,_loc8_,var_78.floorHeight);
         ...
         while(_loc17_ >= 0)
         {
            ...
            while(_loc23_ >= 0)
            {
               _loc6_.setTileHeight(_loc23_,_loc17_,var_78.getTileHeight(_loc23_,_loc17_));
               _loc23_--;
            }
            _loc17_--;
         }
         var _loc18_:XML = var_78.getXML();
         var _loc19_:XML = <dimensions minX="{var_78.minX}" maxX="{var_78.maxX}" minY="{var_78.minY}" maxY="{var_78.maxY}"/>;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new SleepMessageEvent(method_6));
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_969:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_959:
                     _loc10_ = "std";
               }
