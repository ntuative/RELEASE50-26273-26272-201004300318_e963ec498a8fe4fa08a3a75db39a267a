package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1611:IButtonWindow;
      
      private var var_2269:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1611,this._model.mode != ThumbnailEditorModel.const_58);
         setEnabled(var_1612,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1611 = IButtonWindow(find("top_tab"));
         var_1612 = IButtonWindow(find("obj_tab"));
         var_2269 = IWindowContainer(find("tile_grid"));
         var_2268 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1611,onTopTabButton);
         Util.setProcDirectly(var_1612,onObjTabButton);
      }
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = _model.method_8();
         var _loc6_:int = 0;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2269;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_411)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2268;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_60,HabboWindowStyle.const_43,HabboWindowParam.const_72,new Rectangle(0,0,param1.width,66)));
