package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1042:Number = 90;
      
      private static const const_798:int = 50;
      
      private static const const_1041:Number = 25;
      
      private static const const_1133:int = 50;
      
      private static const const_196:Boolean = true;
       
      
      private var var_634:Timer;
      
      private var var_1109:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1109 = param2;
         var_634 = new Timer(const_1041);
         var_634.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_543.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_543.splice(_loc3_,1);
            var_544.splice(_loc3_,1);
         }
         var_544.push(param1.name);
         var_543.push(param2);
         param1.addEventListener(WindowEvent.const_442,windowEventListener);
         param1.addEventListener(WindowEvent.const_201,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_543[var_544.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1109.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_326.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_326.splice(var_326.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1109.getIconLoc(param1.iconId);
      ...
      {
         return var_544[var_543.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_326[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_633[_loc3_] = new Array();
            }
            if(var_633[_loc3_].indexOf(param1) < 0)
            {
               var_633[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_798 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_798 || param1.desktop.height - param1.y < const_1133;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_544.length)
         {
            if(var_544[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_633[_loc3_].length)
                  {
                     repositionWindow(var_633[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
