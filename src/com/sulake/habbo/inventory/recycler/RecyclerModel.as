package com.sulake.habbo.inventory.recycler
{
   ...
   public class RecyclerModel implements IInventoryModel
   {
      ...
      public function startRecycler() : void
      {
         var_34 = STATE_ACTIVE;
         _itemList = new Map();
         var_11.method_1.showRecyclable(true);
      }
      ...
      public function lockSelectedFurni() : int
      {
         ...
         var _loc1_:IItem = var_11.method_1.requestSelectedFurniToRecycler();
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function stopRecycler() : void
      {
         ...
         {
            var_11.method_1.showRecyclable(false);
         }
         else
         {
            _itemList = null;
         ...
         while(_loc1_ < _itemList.length)
         {
            ...
            var_11.method_1.removeLockFrom(_loc2_);
            _loc1_++;
         }
         _itemList = null;
      }
      ...
      public function releaseFurni(param1:int) : Boolean
      {
         ...
         var_11.method_1.removeLockFrom(param1);
