package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_775:int = 15;
      
      private static const const_1097:int = 2;
      
      private static const const_357:int = 2;
      
      private static const const_776:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1060[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1062[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1060 = new Array();
         var_1060.push(Math.random() * _loc2_ * 1.5);
         var_1060.push(Math.random() * _loc2_ * 1.5);
         var_1061 = new Array();
         var_1061.push(1);
         var_1061.push(-1);
         var_1059 = new Array();
         var_1059.push(const_1097);
         var_1059.push(const_1098);
         var_1062 = new Array();
         var_1062.push(getRandomAmplitudeFactor());
         var_1062.push(getRandomAmplitudeFactor());
      }
