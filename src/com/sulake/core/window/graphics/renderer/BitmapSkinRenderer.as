package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_643:Dictionary;
      
      private var var_723:Matrix;
      
      protected var var_644:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_644 = new Dictionary(false);
         var_643 = new Dictionary(false);
         var_723 = new Matrix();
      }
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_644[_loc3_];
         if(_loc4_ == null)
         {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc8_:ISkinTemplate = var_333[param4];
         if(_loc7_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_262)
                  {
                     _loc13_.x += _loc16_;
                  }
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_489)
                  {
                     _loc14_ = true;
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_262)
                  {
                     _loc13_.y += _loc17_;
                  }
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_489)
                  {
                     _loc15_ = true;
                  ...
                  {
                     var_723.a = _loc13_.width / _loc19_.width;
                     var_723.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_723);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_723,null);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_723 = null;
         for(_loc1_ in var_644)
         {
            _loc2_ = var_644[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_644[_loc1_];
         }
         var_644 = null;
         for(_loc1_ in var_643)
         {
            _loc2_ = var_643[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_643[_loc1_];
         }
         var_643 = null;
      }
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_643[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_262)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_262)
               {
