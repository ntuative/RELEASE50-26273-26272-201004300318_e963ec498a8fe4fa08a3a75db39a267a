package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_553:String = "none";
      
      protected var var_647:Number;
      
      protected var var_382:Number;
      ...
      {
         return new Rectangle(var_647 * maxScrollH,var_382 * maxScrollV,width,height);
      }
      ...
      {
         var_647 = param1;
         _field.scrollH = var_647 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_934,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_409,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_409,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_69,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_544,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_544,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_left",var_69.left,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_top",var_69.top,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_right",var_69.right,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_69.bottom,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("auto_size",var_553,PropertyStruct.STRING,var_553 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_544,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_647 = var_647;
         _loc1_.var_382 = var_382;
         _loc1_.var_69 = var_69.clone(_loc1_.setTextMargins);
         _loc1_.var_553 = var_553;
         _loc1_.var_777 = var_777;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_553 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_553 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_553 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_553 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
