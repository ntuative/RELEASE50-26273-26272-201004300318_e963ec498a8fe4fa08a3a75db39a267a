package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1549:IIssueBrowserView;
      
      private const const_1649:String = "open_issues";
      ...
      private const const_1668:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1650:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_231:ITabContextWindow;
      
      private var var_1550:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_359.view.width = var_231.container.width;
         var_359.view.height = var_231.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1650:
               if(var_1548 == null)
               {
                  var_1548 = new MyIssuesView(issueManager,this,var_231.container);
               }
               return var_1548;
            case const_1649:
               if(var_1549 == null)
               {
                  var_1549 = new OpenIssuesView(issueManager,this,var_231.container);
               }
               return var_1549;
            case const_1651:
               if(var_1550 == null)
               {
                  var_1550 = new PickedIssuesView(issueManager,this,var_231.container);
               }
               return var_1550;
            default:
               return null;
