package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_358:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1139:uint = 1;
      ...
      private var var_1384:ProfilerAgentTask;
      
      private var var_1381:IEventDispatcher;
      
      private var var_2408:uint = 0;
      
      private var var_1382:ProfilerAgentTask;
      
      private var var_1383:ProfilerOutput;
      
      private var var_773:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1381 = Component(param1).events;
         var_454 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_773 = new WindowRenderer(var_755);
         var_247 = new Array(const_358);
         var _loc5_:int = 0;
         while(_loc5_ < const_358)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_773,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_247[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_247[const_1139];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_325,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1192,_loc6_);
      }
      ...
      {
         return var_247[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1383 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1383 = new ProfilerOutput(_loc3_,this,var_773);
               var_1384 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1384);
               var_1382 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1382);
               var_1111 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_944.length > 0)
         {
            var_1381.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_358 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1381.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_358)
         {
         ...
         if(WindowContext.var_944.length > 0)
         {
            WindowContext.var_944.flush();
         }
         if(WindowContext.var_1385.length > 0)
         {
            WindowContext.var_1385.flush();
         }
         var_1381.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1148,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1264,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1203,param2.name + ": " + param2.toString());
            }
         }
      }
   }
