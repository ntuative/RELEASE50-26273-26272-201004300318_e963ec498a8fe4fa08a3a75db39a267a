package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_314);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_572);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_603);
         }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_477:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1270));
               break;
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_861));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_34 || _loc5_ == RoomObjectCategoryEnum.const_39)
               {
                  _loc8_ = _loc12_.x;
                  _loc9_ = _loc12_.y;
               }
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_39 && _loc3_.typeId == RoomObjectTypeEnum.const_311)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_232,param1,param2,_loc4_,_loc5_));
         }
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               if(param4 == RoomObjectCategoryEnum.const_39)
               {
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_626,param1,param2,param3,param4));
         }
      }
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_235,param2);
         }
      }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_39 && _loc8_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_34)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_603);
         ...
         if(_loc6_ != null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_39)
            {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_229,MouseEvent.CLICK);
         switch(_loc4_)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc8_ == RoomObjectCategoryEnum.const_39)
                  {
                     if(_loc10_ != null)
                     {
                        setMouseEventId(RoomObjectCategoryEnum.const_70,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_70)
         {
            _loc12_ = getMouseEventId(RoomObjectCategoryEnum.const_70,MouseEvent.CLICK);
            if(_loc12_ != _loc10_)
            {
               _loc13_ = _roomEngine.events;
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_452,param2,param3,-1,RoomObjectCategoryEnum.const_229));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
      ...
      private function useObject(param1:int, param2:int, param3:int, param4:String, param5:String) : void
      {
         if(_roomEngine != null && false)
         {
            switch(param5)
            {
               case RoomObjectFurnitureActionEvent.const_408:
               ...
               case RoomObjectFurnitureActionEvent.const_434:
                  ...
                  break;
               case RoomObjectFurnitureActionEvent.const_370:
               ...
               case RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE:
                  ...
                  break;
               case RoomObjectFurnitureActionEvent.const_421:
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_34 || _loc8_ == RoomObjectCategoryEnum.const_32)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_555,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_314);
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_274:
               ...
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_480:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_334:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_309:
               _loc7_ = "null";
         }
         if(_loc7_ == null)
         {
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_219:
               ...
               break;
            case RoomObjectMouseEvent.const_377:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_1042,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            if(wasSelected)
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_451));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_390));
            }
         }
      }
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_363:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_375:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_314);
      ...
      {
         var _loc3_:Map = var_588.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_588.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_588.add(param1,_loc4_);
         }
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_451);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_390);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_257:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_68:
               ...
               break;
            case RoomObjectMoveEvent.const_412:
            ...
            case RoomObjectFurnitureActionEvent.const_448:
            ...
            case RoomObjectRoomAdEvent.const_309:
               ...
               break;
            case RoomObjectRoomActionEvent.const_363:
            case RoomObjectRoomActionEvent.const_986:
            case RoomObjectRoomActionEvent.const_375:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_367:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_870));
               break;
            case RoomObjectFurnitureActionEvent.const_446:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1296));
               break;
            case RoomObjectFurnitureActionEvent.const_448:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_861));
         }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:String, param4:IRoomGeometry) : void
      {
         ...
         var _loc6_:int = _roomEngine.getRoomObjectCategory(_loc5_);
         if(_loc6_ != RoomObjectCategoryEnum.const_70)
         {
            _loc6_ = 0;
         }
