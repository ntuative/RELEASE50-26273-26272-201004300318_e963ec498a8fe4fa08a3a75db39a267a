package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1561:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_386 != null)
         {
            if(var_386.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_386.window);
            var_386.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1561);
         var_386 = _loc5_;
      ...
      {
         return var_386.dispatchWidgetEvent(param1);
      }
