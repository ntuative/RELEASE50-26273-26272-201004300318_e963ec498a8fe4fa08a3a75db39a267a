package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1263:XML;
      
      private var var_445:int;
      
      private var var_500:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2004:int;
      
      private var var_355:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_60,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1057,const_1058,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_500 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_355 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_500 != null)
         {
            var_500.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_355 != null)
         {
            var_355.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1043 = _loc2_.light;
         if(var_355 != null)
         {
            var_355.setValue(var_1043);
         }
         var_445 = colors.indexOf(_loc2_.color);
         if(var_500 != null)
         {
            var_500.setSelectedColorIndex(var_445);
         }
