package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1147:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_558 != null)
         {
            var_558.visible = false;
            var_558.destroyGridItems();
         }
         if(var_1147 != null)
         {
            var_1147.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1376.text = "${" + _loc3_.name + "}";
            var_1375.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1376.text = "${" + _loc2_.localizationId + "}";
            var_1375.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_38[_loc2_.localizationId]);
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_428:
                  _loc4_ = var_1146.clone();
                  if(var_558 != null)
                  {
                     var_558.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_558,var_1147,var_1139);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_210:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_328,AvatarAction.const_524);
      ...
      {
         var_1376 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1375 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1426 = new Point(var_81.x,var_81.y);
         var_558 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1147 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_558 == null)
         {
         ...
         var_1146 = _loc2_.content as BitmapData;
