package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1580:OpenedToWebPopup;
      
      private var var_900:IAvatarRenderManager;
      
      private var var_189:IHabboToolbar;
      
      private var var_411:FriendListTabs;
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_365.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_365.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_411.findTab(FriendListTab.const_91).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_365 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_88.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_88.addCategory(new FriendCategory(FriendCategory.const_905,getText("friendlist.friends")));
         var_88.addCategory(new FriendCategory(FriendCategory.const_395,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_88.addFriend(new Friend(_loc4_));
         }
         var_411 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_526)
         {
            var_526 = new Timer(120000);
            var_526.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_526.start();
         }
         getBuddyRequests();
         registerListeners();
         var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_526.stop();
            var_526.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_526 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_900)
         {
            var_900.release(new IIDAvatarRenderManager());
            var_900 = null;
         }
         if(var_899)
         {
            var_899.release(new IIDHabboNotifications());
            var_899 = null;
         }
         if(var_189)
         {
         ...
         if(var_608)
         {
            var_608.release(new IIDSessionDataManager());
            var_608 = null;
         }
         super.dispose();
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_87);
      ...
      {
         var _loc1_:String = var_150.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboHelpCom_back_hi_png";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_411.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_288));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1579.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_157,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_365.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_608.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_608.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_365.limit)
         {
            var_365.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_411.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_900.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_365.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_411.findTab(FriendListTab.const_91);
      ...
      {
         return var_150.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1580 == null)
         {
            var_1580 = new OpenedToWebPopup(this);
         }
         var_1580.show(x,y);
      }
