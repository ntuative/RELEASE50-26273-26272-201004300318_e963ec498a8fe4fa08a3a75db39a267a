package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1850 = new RoomThumbnailRenderer(param1);
         var_798 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_173,var_111.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_798.refreshTags(_loc1_,var_111.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1850.refreshThumbnail(_loc1_,var_111.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_173,var_111);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_173,!true ? getEventCtg(var_111.categoryId) : getRoomCtg(var_111.categoryId));
         refreshRoomDesc(var_173,var_111);
         refreshExtraCont();
         refreshInfo(var_173,"trading_allowed",var_111.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_203,Tabs.const_211,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
