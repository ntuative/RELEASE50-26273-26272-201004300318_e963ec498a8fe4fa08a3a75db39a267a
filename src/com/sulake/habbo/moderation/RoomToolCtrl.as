package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1108:ICheckBoxWindow;
      ...
      private var var_768:ICheckBoxWindow;
      
      private var var_51:IFrameWindow;
      
      private var var_1107:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_686,_data.flatId),var_51,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_388);
         if(param1.flatId != var_388)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_388);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_768.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1283,_loc2_,var_409.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1108.isSelected,var_1107.isSelected,var_768.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1303);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1266);
      }
      ...
      public function populate() : void
      {
         ...
         var_768 = ICheckBoxWindow(var_51.findChildByName("kick_check"));
         var_1108 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_1107 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_388));
         Logger.log("BEGINNING TO SHOW: " + var_388);
      }
   }
}
