package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_358:IScrollbarWindow;
      
      private var var_1545:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_358)
         {
            var_358 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_358)
            {
               var_358.addEventListener(WindowEvent.const_253,scrollBarEventProc);
               var_358.addEventListener(WindowEvent.const_201,scrollBarEventProc);
            }
         }
         return var_358;
      }
      ...
      override public function dispose() : void
      {
         if(var_358)
         {
            var_358.removeEventListener(WindowEvent.const_253,scrollBarEventProc);
            var_358.removeEventListener(WindowEvent.const_201,scrollBarEventProc);
            var_358 = null;
         }
         if(var_873)
         {
      ...
      {
         if(param1.type == WindowEvent.const_253)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_873)
         {
            var_873 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_873;
      }
