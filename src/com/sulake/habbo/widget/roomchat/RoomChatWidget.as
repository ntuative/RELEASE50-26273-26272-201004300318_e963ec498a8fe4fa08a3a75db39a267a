package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1038:int = 6000;
      
      private static const const_1039:int = 9;
      ...
      private static const const_1041:int = 25;
      
      private static const const_1040:int = 1;
      
      private static const const_282:int = 9;
      
      private static const const_493:int = 8;
      
      private static const const_348:int = 0;
      
      private static const const_494:int = (const_493 + const_348) * const_102 + const_102;
      ...
      private var var_1661:int = 150;
      
      private var var_462:Number = 1;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_218 = new Array();
         var_656 = new Point();
         var_149 = const_494 + const_282;
         super(param1,param2,param3);
         var_1662 = param5;
         var_37 = param1.createWindow("chat_container","",HabboWindowType.const_60,HabboWindowStyle.const_43,HabboWindowParam.const_42,new Rectangle(0,0,200,var_149 + RoomChatHistoryPulldown.const_79),null,0) as IWindowContainer;
         var_37.background = true;
         var_37.color = 33554431;
         var_37.tags.push("room_widget_chat");
         var_335 = param1.createWindow("chat_contentlist","",HabboWindowType.const_996,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,200,var_149),null,0) as IItemListWindow;
         var_37.addChild(var_335);
         var_122 = param1.createWindow("chat_active_content","",HabboWindowType.const_60,HabboWindowStyle.const_42,HabboWindowParam.const_72,new Rectangle(0,0,200,var_149),null,0) as IWindowContainer;
         var_335.addListItem(var_122);
         var_26 = new RoomChatHistoryViewer(this,param1,var_37,param2);
         var_1661 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_513,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_698,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_149 = const_494 + const_282;
         var_37.height = var_149 + var_26.pulldownBarHeight;
         var_335.width = 0 - 0;
         var_335.height = var_149;
         var_122.width = 0 - 0;
         if(historyViewerActive())
         {
            var_122.height = getTotalContentHeight() + const_282;
         }
         else
         {
            var_122.height = var_149;
         }
         var_335.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_956)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_65.length > const_1040 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_655 = getTimer() + const_748;
         }
         else
         {
            if(false && false)
            {
               var_557 = getItemSpacing(_itemList["-1"],var_65[0]);
            }
            else
            {
               var_557 = const_102;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_656.x) * var_785;
      ...
      {
         return "chat_" + var_1662.toString() + "_item_" + (var_1660++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_513,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_698,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_462);
            if(_loc2_ == -1)
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_437)
         {
            _loc2_ = param1 / const_1041 * const_1042;
            if(_loc2_ + var_654 > var_557)
            {
               _loc2_ = var_557 - var_654;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1415 == 0)
            {
               var_1415 = param1.scale;
            }
            else
            {
               var_785 = param1.scale / var_1415;
            }
         }
         if(param1.positionDelta != null)
         {
            var_656.x += param1.positionDelta.x / var_785;
            var_656.y += param1.positionDelta.y / var_785;
         }
         if(param1.rect != null)
         {
            if(var_26 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1661)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_462,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_462;
               if(_loc1_.aboveLevels > const_493 + const_348 + 2)
               {
                  _loc1_.aboveLevels = const_493 + const_348 + 2;
               }
               var_462 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_149 = param1 - 0;
         var_37.height = var_149 + RoomChatHistoryPulldown.const_79;
         if(var_26 != null)
         {
            var_26.containerResized(var_37.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_672,param1,param2,param4,param5);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_348 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1038)
               {
