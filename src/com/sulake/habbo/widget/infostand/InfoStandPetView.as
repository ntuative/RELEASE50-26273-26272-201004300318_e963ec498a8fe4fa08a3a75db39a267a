package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1663:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1661:String = "level";
      
      private var var_101:IItemListWindow;
      
      private const const_1666:String = "energy";
      
      private var var_1249:Map;
      
      private const const_1664:String = "nutrition";
      
      private var var_62:IItemListWindow;
      
      private const const_1662:uint = 3355443;
      
      private var var_221:IBorderWindow;
      
      private const const_1658:int = 158;
      
      private const const_1660:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_184:PetCommandTool;
      
      private const const_1659:uint = 11184810;
      
      private const const_1665:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_221.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_221.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         for each(_loc8_ in _loc7_)
         {
            ...
            _loc8_.addEventListener(WindowEvent.const_47,onButtonResized);
         }
      }
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_101.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_101.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_184 == null)
         {
            var_184 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1249.getValue(var_585) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_184.showWindow(true);
            var_184.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_101.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_101.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1661,param1.level,param1.levelMax);
         updateStateElement(const_1665,param1.experience,param1.experienceMax);
         updateStateElement(const_1666,param1.energy,param1.energyMax);
         updateStateElement(const_1664,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_585 = param1.id;
         var_1249.remove(param1.id);
         var_1249.add(param1.id,param1);
         if(var_184 && var_184.isVisible() && param1.isOwnPet)
         {
            var_184.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_101.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_184.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_184 && var_184.getPetId() == var_585)
               {
                  var_184.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_410,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1658,const_1660,false);
