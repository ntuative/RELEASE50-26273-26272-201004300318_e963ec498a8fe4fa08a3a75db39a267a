package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_378:String = "fx";
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_2255 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1201 = parseInt(param2.@dy);
         var_1200 = parseInt(param2.@dz);
         var_1328 = parseInt(param2.@dd);
         _type = param3;
         var_1103 = String(param2.@base);
      ...
      public function baseAsInt() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_1103.length)
         {
            _loc1_ += var_1103.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
