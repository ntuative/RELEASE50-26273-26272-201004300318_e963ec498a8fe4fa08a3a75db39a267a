package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_11.method_1;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_76,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_634);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_11.method_1;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_163)
            {
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_317))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         {
            _loc3_.method_2(_loc4_);
         }
         var_11.setInventoryCategoryInit(InventoryCategory.const_145);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_11.setInventoryCategoryInit(InventoryCategory.const_310);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_76);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_259);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_245);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_317);
         var _loc4_:FurniModel = var_11.method_1;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
