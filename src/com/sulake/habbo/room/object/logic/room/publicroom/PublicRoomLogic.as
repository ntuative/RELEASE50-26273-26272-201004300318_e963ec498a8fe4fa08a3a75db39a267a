package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_456,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_722,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_456,Number(false));
         var_845 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_815:
                  _loc2_.setString(RoomObjectVariableEnum.const_286,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_722,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_456,Number(true));
                  var_1014 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_873);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_359)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_722);
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_359)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_309,_loc5_,_loc6_));
               }
         }
      }
   }
