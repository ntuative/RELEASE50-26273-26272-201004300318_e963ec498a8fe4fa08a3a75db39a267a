   ...
   public class SubstituteParentController extends WindowController
   {
      ...
      override public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            param1.removeEventListener(WindowEvent.const_98,childParamUpdated);
            param1.parent = null;
            return param1;
         }
         return null;
      ...
      private function childParamUpdated(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_.removeEventListener(WindowEvent.const_98,childParamUpdated);
         }
      ...
      override public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         _loc3_.addEventListener(WindowEvent.const_98,childParamUpdated);
         return param1;
      }
