   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_139,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_180,_windowManager,_assetLibrary);
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_177,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_147 == "")
         {
            _model.switchCategory(FigureData.const_139);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_hair":
                  ...
                  break;
               case "tab_hat":
                  switchCategory(FigureData.const_180);
                  break;
