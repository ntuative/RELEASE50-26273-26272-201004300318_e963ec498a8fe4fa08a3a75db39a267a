package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1054:int = 0;
      
      private static const const_349:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_674 == null || _loc3_ < 0 || _loc3_ >= var_674.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_674[_loc3_];
            main.showUI(HabboHelpViewEnum.const_632);
            main.tellUI(HabboHelpViewEnum.const_632,null);
         }
      }
   }
}
